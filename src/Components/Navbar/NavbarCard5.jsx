...
function NavbarCard5() {
    ...
    const delayy = useRef(null);

   function handleMouseEnter(){
    clearTimeout(delayy.current);
    setVisible(true);
    console.log("mouseEnter");
   }

   function handleMouseLeave(){
    delayy.current= setTimeout(()=>{
      setVisible(false);
    },300);
   }
          ...
          <Link to="/products">
            <Box>
              <Grid gridTemplateColumns="repeat(5, 1fr)" w="100%">
                ...
                <Flex direction="column" gap="6"  marginLeft="20">
                  <Box
                    fontSize="md"
                    fontWeight="bold"
                    borderBottom="1px solid black"
                ...
                <Flex direction="column" gap="6" marginLeft="10">
                  <Box
                    fontSize="md"
                    fontWeight="bold"
                    borderBottom="1px solid black"
