...
//         ` https://lens.princy.shop/api/brandsdetails`
//        );
...
const NewProduct = () => {
  ...
  const fetchproduct = async () => {
    setIsLoaded(true);
    try {
      const response = await fetch("https://lens.princy.shop/api/brandsdetails");
  ...
  const handleClick = (value) => setProductRef(value);
  const handleClick2 = (value) => setProductRef(value);
      ...
      <Box>
        ...
        <Flex m="0" px="2%" gap="4" cursor="pointer">
          <Flex
            ...
            flexDirection="column"
          >
            <ProdFrame heading={"FRAME TYPE"} type={Frame1} filter={handleClick} />
            <ProdFrame heading={"FRAME SHAPE"} type={Frame2} filter={handleClick2} />
            <ProdFilter
              type={Gender}
              heading={"GENDER"}
              handlechange={setGender}
