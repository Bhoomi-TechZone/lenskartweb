  ...
  return (
    ...
    >
      <Box fontSize="35px" w="97%" margin="auto">
        Buy The Best Eyewear From SPX
      </Box>
      <br />
      <Box fontSize="15px" w="97%" margin="auto" pb="5" textAlign="justify">
        <Box w="95%">
          SPX Is The Leading E-Commerce Portal For Eyewear In India. It Has
          ...
          Technology While Purchasing Online, SPX Caters To Every Customer
        ...
        <Box w="95%" textAlign="justify">
          ...
          SPX Delivers Them Right At Your Doorstep With Convenient Methods
